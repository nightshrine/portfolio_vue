...
export const getAboutInfoList = (): IAboutInfo[] => {
  const aboutInfoList = [
    ...
    {
      title: "大学",
      text: "静岡大学大学院・総合科学技術研究科・情報学専攻 修士1年",
    },
    {
      title: "email",
      text: "yamamoto.shunsuke.20@shizuoka.ac.jp",
    },
    {
      title: "Github",
      text: "@nightshrine",
...
export const getHistoryInfoList = (): IHistoryInfo[] => {
  const historyInfoList = [
    ...
    {
      title: "2024年5月",
      text: "企業連携で、機械学習を用いた推定モデルの開発を行います（非公開研究のため、現在は詳細について記載できません）。また、学部4年で行っていた類似特許検索の研究については、他の方が引き継ぐことになったため、既存のコードのリファクタリングや必要な拡張も同時並行で行っています。",
    },
  ];
